...
import { BlogCreatePage } from '@/components/templates'
...
const BlogCreate: NextPageWithLayout = () => {
  ...
  return <BlogCreatePage {...props} />
}

BlogCreate.getLayout = function getLayout(page: ReactElement) {
