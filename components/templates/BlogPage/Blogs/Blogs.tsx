    ...
    <>
      <div className={Styles.Blogs}>
        <div className={Styles.Popular}>
          ...
          <div
            className={clsx(Styles.BlogGrid, {
              [Styles.BlogList as string]: layout === 'List'
            })}
          >
            {[...Array(10)].map((_, index) => (
              <motion.div key={index} className={Styles.Blog}>
                <ArticleCard
                  url={`/articles/${index}`}
      ...
      <SpeedDial tooltip="Click for create new blog">
        <Button mode="warning" icon={<TbWritingSign size={20} />}>
          <Link href="/blogs/create">Write your blog</Link>
        </Button>
      </SpeedDial>
    </>
  )
